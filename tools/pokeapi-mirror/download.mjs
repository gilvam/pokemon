...
//   node tools/pokeapi-mirror/download.mjs
//
// Resultado (pasta gitignored, ~1,9 GB):
//   pokeapi-mirror/data/api/v2/<endpoint>/<id>/index.json   (idêntico ao upstream)
//   pokeapi-mirror/media/sprites/...                         (idêntico ao upstream)
//   pokeapi-mirror/index/<endpoint>.json                     (lista completa p/ paginação)
//   pokeapi-mirror/index/<endpoint>.names.json               (mapa nome -> id)
...
const MIRROR_DIR = resolve(process.env.POKEAPI_MIRROR_DIR ?? './pokeapi-mirror');
